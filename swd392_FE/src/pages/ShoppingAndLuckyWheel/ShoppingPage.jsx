              ...
              packages.map((pkg) => (
                ...
                >
                  ...
                  {pkg.price ? (
                    ...
                    pkg.blindBoxes.$values.length > 0 ? (
                    <p className="text-green-600 font-bold text-lg">
                      {pkg.blindBoxes.$values[0].discountedPrice.toLocaleString(
                        "vi-VN"
                      )}{" "}
                      ₫
                      {pkg.blindBoxes.$values[0].discount > 0 && (
                        <span className="text-sm text-gray-500 line-through ml-2">
                          {pkg.blindBoxes.$values[0].price.toLocaleString(
                            "vi-VN"
                          )}{" "}
                          ₫
                        </span>
                    ...
                    <p className="text-green-600 font-bold text-lg">
                      {pkg.blindBoxes[0].discountedPrice.toLocaleString(
                        "vi-VN"
                      )}{" "}
                      ₫
                  ...
                  <Link
                    to={`/package-detail/${pkg.pakageCode}`}
                    className="mt-2 w-full bg-pink-500 text-white py-2 rounded-lg hover:bg-pink-600 transition text-center block"
                  >
                    Xem chi tiết
                  </Link>
                </div>
